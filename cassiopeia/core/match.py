...
class ParticipantData(CoreData):
    ...
    def __call__(self, **kwargs):
        ...
        stats = {
            ...
            "onMyWayPings": kwargs.pop("onMyWayPings", None),
            "assistMePings": kwargs.pop("assistMePings", None),
            "commandPings": kwargs.pop("commandPings", None),
            "dangerPings": kwargs.pop("dangerPings", None),
            "getBackPings": kwargs.pop("getBackPings", None),
            "holdPings": kwargs.pop("holdPings", None),
            "needVisionPings": kwargs.pop("needVisionPings", None),
            "allInPings": kwargs.pop("allInPings", None),
